...
<head>
    ...
    <title>Dashboard | App Resto</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    @role('admin')
                        <a class="nav-link" href="{{ route('dashboard.menu.index') }}">Tambah Menu</a>
                        <a class="nav-link" href="{{ route('dashboard.staff.index') }}">Tambah Staff</a>
                    @endrole

                    @role('staff')
                        <a class="nav-link" href="{{ route('dashboard.transactions.index') }}">Konfirmasi Transaksi</a>
                        <a class="nav-link" href="{{ route('dashboard.tables.index') }}">Update Status Meja</a>
                    @endrole
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('template/logik/assets/images/favicon.ico') }}" />

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="{{ asset('template/logik/assets/css/libs.min.css') }}">

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('template/logik/assets/css/logik.css?v=1.0.0') }}">
</head>
...
<body class="  ">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        ...
                                        @role('staff')
                                        <p class="mb-0 caption-sub-title">Staff</p>
                                        @endrole
                                    </div>
                                </a>
    ...
    <script src="{{ asset('template/logik/assets/js/libs.min.js') }}"></script>

    <!-- Dashboard Charts JavaScript -->
    <script src="{{ asset('template/logik/assets/js/charts/dashboard.js') }}"></script>
    <script src="{{ asset('template/logik/assets/js/charts/apexcharts.js') }}"></script>

    <!-- fslightbox JavaScript -->
    <script src="{{ asset('template/logik/assets/js/fslightbox.js') }}"></script>
